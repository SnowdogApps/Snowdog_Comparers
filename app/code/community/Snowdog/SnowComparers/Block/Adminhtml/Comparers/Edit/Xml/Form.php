 ...
 *  @author Snowdog
 */
class Snowdog_SnowComparers_Block_Adminhtml_Comparers_Edit_Xml_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    public function __construct()
    {
        ...
        $this->setTitle(Mage::helper('snowcomparers')->__('XML comparers feed'));
    }
    ...
    protected function _prepareForm()
    {
		...
		$fieldset->addField('header', 'editor', array(
            'label' => Mage::helper('snowcomparers')->__('Header'),
            'name'  => 'header',
            'required' => false,
		...
		$fieldset->addField('footer', 'editor', array(
            'label' => Mage::helper('snowcomparers')->__('Footer'),
            'name'  => 'footer',
            'required' => false,           
		...
		$note=Mage::helper('snowcomparers')->__("First line is node name for single item (eg. <offer> or <item>). Following lines are nodeName:function where function might be attribute name or one of following:\n");
		$note.=rtrim(implode(',',Mage::helper('snowcomparers/scheme_xml')->getFunctions()),', ');
		...
		$fieldset->addField('base', 'select', array(
            ...
            'required' => true,            
            'value' => $model->getBase(),
			'values'   => Mage::getModel('snowcomparers/schemeList_Xml')->toOptionArray()
        ));
		...
		$fieldset->addField('sku_filter', 'text', array(
            ...
            'name'  => 'sku_filter',
            'required' => false,
            'note'  => Mage::helper('snowcomparers')->__('Coma seperated list'),
